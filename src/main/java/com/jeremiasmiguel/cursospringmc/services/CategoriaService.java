...
public class CategoriaService {
	...
	public void delete(Integer id) {
		 ...
		 * relacionadas, por exemplo, a entidade Categoria pode conter Produtos
		 * relacionados a ela, se houver, a exclusão é abortada por meio dessa captura
		 * de uma exceção personalizada criada (DataIntegrityException)
		 */
		catch (DataIntegrityViolationException exception) {
			throw new DataIntegrityException(
					"Não é possível realizar a exclusão de uma Categoria que contenha Produtos.");
		}
	}
